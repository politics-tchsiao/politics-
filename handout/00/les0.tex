...
\end{center}
\end{frame}
\begin{frame}{Metaphor (In examination)}
\begin{center}
\includegraphics[width=0.55\textwidth]{hello_asm.png}
\end{center}
\begin{center}
\fbox{Hello, World!}
\end{center}
...
1 & Lesson 0 & \\
\hline
2 - 4 & Lesson 1 & Chap 2 to 6\\
\hline
5 - 6 & Lesson 2 & Chap 8 to 10\\
\hline
7 & \textcolor{Green}{Prepare examination} & \\
\hline
8 & \textcolor{red}{Midterm examination} & \\
\hline
9 - 11 & Lesson 3 & Chap 11 to 15 \\
\hline
12 & \textcolor{purple}{Midterm examination explanation} & \\
\hline
...
\end{center}
\end{frame}
\begin{frame}{Look closer}
\begin{center}
\includegraphics[width=0.4\textwidth]{endeavor2.png}
\end{center}
\begin{center}
After if identifier in AEP is a selected statement, means safing zone can exist between 59.48 to 59.49.
\end{center}
\end{frame}
\begin{frame}{Contact}
\begin{center}
