...
\begin{frame}{}
\begin{center}
\includegraphics[width=0.5\textwidth]{/Users/tom/Downloads/instructor.png}
\end{center}
\vspace{1em}
\begin{center}
...
\pause
\item Only permitted to bring a main or reference book to the examinations.
\pause
...
\begin{itemize}
\pause
\item Memorize or copying down all the explanations.
\pause
...
\pause
\begin{itemize}
\item The overall score "may" be adjusted by the instructor due to the Average Equility Policy (AEP).
\end{itemize}
\end{block}
\end{frame}
