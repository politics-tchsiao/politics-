...
\end{center}
\begin{itemize}
\item I was \textcolor{red}{scammed} 200,000 NTD before.
\item Separate as:
\begin{enumerate}
\item 10,000 NTD.
...
\item My life $\rightarrow$ Miserable memory (\textcolor{red}{Greedy must not a good choice}).
\end{itemize}
\end{frame}
\begin{frame}{Alert every links}
\begin{center}
