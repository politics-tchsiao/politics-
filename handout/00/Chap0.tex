...
\item If you diagonsed with disabilities, the alternative way is hand in reports to replace the examinations, the formula is as follows. \\
\end{enumerate}
\begin{align*}
\text{Overall score} &= \text{Attendance} \times 0.30 + \\
&\quad \frac{\text{Midterm report} \times 0.35 + \text{Final report} \times 0.35}{2}
\end{align*}
\end{frame}
\begin{frame}{Alternative way (Cont'd)}
\begin{enumerate}
\item Separate some students to the corner of the examination room and print out the short essay problems to those. \\  
