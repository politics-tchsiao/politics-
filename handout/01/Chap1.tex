...
\node[draw, rectangle, minimum width=1cm, minimum height=1cm] (bottom) at (1, -1.5) {Executive \\ Cabinet header is PM};
\draw[->] (top.south) -- (mid.north) node[midway, left] {Elect};
\draw[->] (mid.south) -- (bottom.north) node[midway, left] {Elect};
\end{tikzpicture}
\end{center}
\begin{center}
...
\end{center}
\end{frame}
\begin{frame}{A System of our government II}
\begin{center}
\begin{tikzpicture}
\node[draw, rectangle, minimum width=1cm, minimum height=1cm] (top) at (1, 1.5) {Electorate};
\node[draw, rectangle, minimum width=1cm, minimum height=1cm] (midL) at (0, -0.5) {Assembly};
\node[draw, rectangle, minimum width=1cm, minimum height=1cm] (midR) at (2, -0.5) {President};
\node[draw, rectangle, minimum width=1cm, minimum height=1cm] (bottom) at (2, -2.5) {Cabinet};
\draw[->] (top.south) -- (midL.north) node[midway, left] {Elect};
\draw[->] (top.south) -- (midR.north) node[midway, left] {Elect};
...
\end{center}
\end{frame}
\begin{frame}{A System of our government III}
\begin{minipage}{0.45\textwidth}
\begin{center}
\begin{tikzpicture}
\node[draw, rectangle, minimum width=1cm, minimum height=1cm] (top) at (1, 1.5) {Electorate};
\node[draw, rectangle, minimum width=1cm, minimum height=1cm] (midL) at (0, -0.5) {Assembly};
\node[draw, rectangle, minimum width=1cm, minimum height=1cm] (midR) at (2, -0.5) {President};
\node[draw, rectangle, minimum width=1cm, minimum height=1cm] (bottom) at (0, -2.5) {Cabinet};
\node(1) at (2, -2.5) {};
\draw[->] (top.south) -- (midL.north) node[midway, left] {Elect};
\draw[->] (top.south) -- (midR.north) node[midway, left] {Elect};
