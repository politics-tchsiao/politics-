...
This document explains some requirements for those who want to enroll in this course, there are \textcolor{red}{10} requirements available, the limited space in our classroom is \textcolor{red}{60} seats. \\
...
\end{verbatim}
\item The period counts on \textcolor{red}{09:00 to 16:00 (NST), Thursday and Friday (Week 01)}, earlier or later must be rejected, the result will be published on the course webpage before week 02.
\end{enumerate}
\end{document}
